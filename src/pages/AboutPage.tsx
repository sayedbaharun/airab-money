  ...
  return (
    <>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-8">
                <div className="grid grid-cols-2 gap-6">
                  <div className="text-center">
                    ...
                    <div className="text-sm text-gray-600">Expert Guests</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-emerald-600 mb-2">100+</div>
                    <div className="text-sm text-gray-600">Episodes Planned</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-amber-500 mb-2">7</div>
                    <div className="text-sm text-gray-600">GCC Countries</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-purple-600 mb-2">3</div>
                    <div className="text-sm text-gray-600">Episodes/Week</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg mx-auto text-gray-600">
              ...
              <div className="bg-blue-50 border-l-4 border-blue-500 p-6 my-8">
                <h3 className="text-xl font-semibold text-blue-900 mb-3">What Makes Us Different</h3>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Meet Our AI-Powered Hosts</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              <div key={index} className={`grid grid-cols-1 lg:grid-cols-2 gap-12 items-center ${
                ...
                <div className={index % 2 === 1 ? 'lg:col-start-1' : ''}>
                  <div className="space-y-6">
                    <p className="text-lg text-gray-600 leading-relaxed">{host.bio}</p>
